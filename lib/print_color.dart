...
class Print {
  ...
  ///------------------------------------
  static black(text, {name = 'black'}) =>
      log('\x1B[30m$text\x1B[0m', name: name);
  ...
  ///------------------------------------
  static green(text, {name = 'green'}) =>
      log('\x1B[32m$text\x1B[0m', name: name);
  ...
  ///------------------------------------
  static magenta(text, {name = 'magenta'}) =>
      log('\x1B[35m$text\x1B[0m', name: name);
  ...
  ///------------------------------------
  static white(text, {name = 'white'}) =>
      log('\x1B[37m$text\x1B[0m', name: name);
}
